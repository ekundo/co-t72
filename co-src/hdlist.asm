...
PUTAT   EQU 02071h              ; подвод курсора: L -- строка, H -- колонка
PARKROW EQU 037h                ; куда CO уводит курсор, дорисовав панель
PARKCOL EQU 06Ch                ; ... строка 23, колонка 76
...
lhi:    LDA  lcur
        ...
        LXI  H,lnorm
        RST  3
; Курсор увести туда же, куда его уводит CO, дорисовав панель: иначе он мигает
; сразу за строкой под курсором, чего в списке файлов не бывает.
        LXI  H,PARKCOL*256+PARKROW
        JMP  PUTAT
