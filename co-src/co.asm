...
BAR1:    .db 1Bh,'b1-Помощь 2-Меню 3-Просм. 4-Мedit 5-Копия 6-Имя 7-Диск 8-Убрать 9-Sys.прм 0-Монит',1Bh,'a',0 ; ПРАВКА
BARLEN   EQU 80                                               ; знаков в строке
BAR2:    .db '1-40/60 2-Атрибуты 3-Просм.К7 4-VDE 5-КсЗИ  6-Запись 7-Hdd 8-Файл 9-Sid  0-Выход',0 ; ПРАВКА
EMPTY:   .ds 13                                               ; ПРАВКА
