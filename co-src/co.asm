...
; И курсор увести туда же, куда его уводит CO, дорисовав панель: иначе он
; мигает сразу за строкой под курсором, чего в списке файлов не бывает.
; Врезка по 2BA6, на месте подсветки строки.
ARCPARK: CALL L_2DD0                       ; ПРАВКА
         LXI  H,06C37h                     ; ПРАВКА строка 23, колонка 76
         JMP  L_2071                       ; ПРАВКА
         .ds  59-(ARCPARK+9-ARCBAR)        ; ПРАВКА остаток прежнего меню
