...
; в блок. Проверку буквы правит сборка -- см. tools/dsel.py.
...
; прочих другая (179B); адрес вписывается в вызов по 1767. Эту
; проверку сборка тоже правит -- см. tools/dsel.py.
...
; в вызов по 16C9. Сборка правит эту проверку, чтобы второй
; квазидиск шёл ветвью «C», -- см. tools/dsel.py.
...
L_40CC:  PUSH PSW                 ; 40CC f5
         ...
         POP  PSW                 ; 40D9 f1
         RET                      ; 40DA c9
; Набивка до конца образа. Сюда сборка ставит стаб переносчика: он копирует
; хвост под стек, ставит стек ниже буфера дисковода T-72 и уходит на 4071 --
; см. tools/relocstub.py.
L_40DB:  NOP                      ; 40DB 00
         NOP                      ; 40DC 00
         NOP                      ; 40DD 00
L_40DE:  NOP                      ; 40DE 00
