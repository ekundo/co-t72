...
L_2DD0:  PUSH PSW                 ; 2DD0 f5
         ...
         RST  3                   ; 2DDC df
         RET                      ; 2DDD c9
; Строка размера в рамке: число переводится в знаки (0E1B) и
; подставляется в шаблон по 3581.
...
L_32C2:  RET                      ; 32C2 c9
; Просмотрщик: перейти к следующей строке файла -- читать байты до
; перевода строки, подтягивая буфер, когда он кончился.
