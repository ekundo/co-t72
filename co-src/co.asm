...
; подсказку вернёт отрисовка панели на выходе -- 091E печатает её через 0E54.
;
...
arcnrm:  .db  01Bh,'a',0                   ; ПРАВКА и обратно
...
L_2DC3:  CALL L_0C7E                       ; ПРАВКА шапки обеих панелей
         CALL L_091E                       ; ПРАВКА список панели заново
         CALL L_0890                       ; ПРАВКА строка под курсором
         POP  H                   ; 2DCC e1
