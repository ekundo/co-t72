...
# «СС»-«7» открывает список дискет, ВК на строке назначает. Курсор встаёт на
# первую дискету, поэтому ВК сразу даёт дискету 1 -- на ней HDIR.COM.
probe ссемь    "$HDSEL" '"Tab", 100, "\001Left Shift", 10, "7", 20, "\002Left Shift", 400, "Return", 900' винт
# То же со стрелкой: вниз и ВК -- дискета 2, на ней CO.HLP. Этим проверяется
# и сам список: чтение винчестера портами, сбор страницы, курсор.
probe списокнжмд "$HDSEL" '"Tab", 100, "\001Left Shift", 10, "7", 20, "\002Left Shift", 400, "Down", 200, "Return", 900' винт
...
probe меткасписком "$HDSEL" '"Tab", 100, "\001Left Shift", 10, "7", 20, "\002Left Shift", 400, "Down", 250, "6", 250, "L", 40, "S", 40, "T", 40, "Return", 700' винт
