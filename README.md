...
Дискета загрузочная: на её системных дорожках та же сборка T-72, что и в `.rom`.

ПЗУ — сборка ImproverX от 15.09.2026, она же лежит в [`roms/`](roms/). Именно её,
а не сборку из репозитория T-72: таблицу состава оборудования ImproverX завёл
позже исходников, и на старых ПЗУ CO не показывает номер дискеты НЖМД и не знает
состава машины.
