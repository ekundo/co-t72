...
| сборка | образ системы | оборудование |
|---|---|---|
...
(и `HDIREN.COM` — то же по-английски), образ системы T-72 и `README.txt`.
...
с системой, CO и HDIR. Оба образа с автозапуском: после загрузки CO поднимается
сам.
...
`FFCC`. Сборки различаются только образом системы и готовыми образами дискеты
и квазидиска.
