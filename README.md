...
Восемьдесят семь сценариев, от стрелок до копирования, распаковки архива и
...
только первый байт команды. Сейчас — 84% команд листинга.
...
выходило бы 90%, то есть на 458 команд больше, чем CO исполнила.
