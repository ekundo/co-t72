...
HDIR /M 5 ИГРЫ    метка дискеты 5, до 32 знаков; без текста — снять
...
НЖМД читается напрямую портами, теми же и в том же порядке, что и БСВВ, — одна
сборка годится для всех трёх ПЗУ.
