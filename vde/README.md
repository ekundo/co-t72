...
| `^X` против «вправо» | 18h — это и стрелка вправо, и вордстаровское «вниз». `AdjKey` сверяет свою таблицу и вордстаровскую вперемешку, по паре на шаг, и `^X` стоит на шаг раньше «вправо» — стрелка уводила курсор вниз. Различить их нельзя, на Векторе это один код, поэтому он отдан стрелке: она клавиша, а не привычка. «Вниз» осталось на своей стрелке, «вправо» у WordStar — `^D`. |
