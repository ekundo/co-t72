...
echo
echo "запуск с винчестером:"
echo "  cd stand && ./Emu80lite --platform vector --run ../tools/MDOS_T-72/BIN/os-t72hx.rom \\"
echo "      --edd ../out-hx/co-t72.edd --disk-a ../out-hx/co-t72.fdd --hdd ~/Documents/vector.hdd"
