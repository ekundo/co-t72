...
def build(at):
    ...
    # запомнить диск, с которого запущен CO: там же лежит и CO.HDD. В 0004
    # младшая тетрада -- диск, старшая -- номер пользователя, поэтому маска.
    a.word(0x3A, 0x0004); a.db(0xE6, 0x0F, 0x3C); a.ref(0x32, 'homedrv')
