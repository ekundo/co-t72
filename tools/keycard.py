...
GROUPS = [
    ('Панели и командная строка', [
        ...
        ('↑ ↓', 'курсор по панели на строку вверх и вниз'),
        ('→ ←', 'курсор по командной строке; если она пуста -- в соседний'
                ' столбец панели'),
        ('СС+→  СС+←', 'курсор в соседний столбец панели -- даже когда в'
                       ' командной строке что-то набрано'),
        ('ЗБ', 'стереть знак перед курсором'),
        ('F3  F1', 'история команд, переданных системе: F3 -- шаг назад,'
                  ' F1 -- вперёд; помнит 14 последних'),
