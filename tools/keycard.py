...
GROUPS = [
    ('Панели и командная строка', [
        ...
        ('↑', 'двигать курсор по панели на строку вверх'),
        ('↓', 'на строку вниз'),
        ('→', 'двигать курсор по командной строке вправо; если она пуста —'
               ' переходить в соседний столбец панели'),
        ('←', 'то же влево'),
        ('СС+→', 'переводить курсор в соседний столбец панели вправо — даже'
                 ' когда в командной строке что-то набрано'),
        ('СС+←', 'то же влево'),
        ('ЗБ', 'стереть знак перед курсором'),
        ('F3', 'подставить предыдущую команду из истории — помнит 14 последних'),
        ('F1', 'подставить следующую'),
    ...
    ('Цифры — при пустой командной строке', [
        ('1', 'показать встроенную справку — файл CO.HLP'),
        ('2', 'открыть меню пользователя — его задаёт файл CO.MNU'),
        ...
        ('8', 'удалить'),
        ('9', 'открыть настройки: искать ли файлы на диске B, показывать ли'
              ' системные файлы, цвета и гашение экрана, проверка при'
              ' копировании, порядок сортировки'),
        ('0', 'погасить монитор'),
    ]),
    ('СС + цифра', [
    ...
    ('Просмотрщик', [
        ('↑', 'листать экран назад'),
        ('↓', 'листать вперёд'),
        ('F1', 'сдвинуть текст на строку вверх'),
        ('F4', 'на строку вниз'),
