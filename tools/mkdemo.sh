...
Отсюда видно, как CO работает с .PK2: клавиша ВК на архиве открывает его
каталог, ВК на файле внутри -- распаковывает. Распаковкой занимается ARC2,
он должен лежать на одном из дисков.
