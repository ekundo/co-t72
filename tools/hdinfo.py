...
относит под стек стаб из relocstub.py; копировщик оттуда переносит тело на 4600
...
def main():
    ...
    copier = bytes([0x21, at_body & 0xFF, at_body >> 8,      # LXI H,тело
                    0x11, BODY & 0xFF, BODY >> 8,            # LXI D,тело
