...
машины. А дисковый обработчик берётся не адресом, а ссылкой: в --disk передаётся
...
живой машине: по этим адресам лежат записи каталога. Всё, что мы туда положим,
...
# Признак ">CO.PTK" (режим «ПС») CO рисует в нижней рамке и остаётся на своём
# штатном месте: пока надпись жила там же, сборка двигала его к уголку, чтобы
# освободить место, а с переездом надписи на верхний край рамки двигать незачем.
