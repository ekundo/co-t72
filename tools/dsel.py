...
Значит переключать надо не по букве в произвольном месте, а непосредственно
вокруг самого обращения: найти общий вход в доступ к квазидиску (кандидаты --
03B0, 0D90, 3480: везде XRA A / OUT 10h ... MVI A,23h / OUT 10h) и ставить порт
там по текущему диску, возвращая 10h после. Тогда трамплины по буквам не нужны
вовсе.
