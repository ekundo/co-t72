...
ORG = 0x100
# Тело надписи в рамке панели (tools/hdinfo.py, BODY) -- выше него не
# заходить. Оно сдвинуто к верхнему краю дыры, чтобы цепочке накладок с A448
# осталось место: их уже шесть.
LABEL = 0xA660
